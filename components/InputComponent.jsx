...
import { scaleFont, scalePadding } from "../constants/font";
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    padding: scalePadding(12), // Padding inside the input field
    fontSize: scaleFont(16), // Font size of input text
  ...
  errorText: {
    ...
    fontSize: scaleFont(12), // Smaller font size
