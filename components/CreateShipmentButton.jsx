...
const styles = StyleSheet.create({
  ...
  createButton: {
    ...
    paddingVertical: scalePaddingVertical(8), // Top and bottom padding
    paddingHorizontal:scalePaddingHorizontal(20) , // Left and right padding
  ...
  createButtonText: {
    ...
    fontSize: scaleFont(14), // Text size
